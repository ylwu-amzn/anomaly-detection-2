...
public class ADBatchTaskRunner {
    ...
    private void updateDetectorLevelTaskState(String detectorId, String detectorTaskId, String newState) {
        ...
        logger.info("aaaaaaaaaa updateDetectorLevelTaskState task : {}, {}", detectorTaskId, newState);
        if (adTaskCacheManager.detectorTaskStateExists(detectorId)) {
            logger.info("aaaaaaaaaa detector state cache  : {}", adTaskCacheManager.getDetectorTaskState(detectorId));
    ...
    private boolean hcTaskStateChanged(String oldState, String newState) {
        if (!Objects.equals(oldState, newState)) {
            logger.info("aaaaaaaaaa hc task state changed, oldState: {}, new State: {}", oldState, newState);
            return true;
        }
        logger.info("aaaaaaaaaa hc task state doesn't change, oldState: {}, new State: {}", oldState, newState);
        return false;
    }
