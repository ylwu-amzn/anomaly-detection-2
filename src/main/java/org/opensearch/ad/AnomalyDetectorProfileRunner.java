...
public class AnomalyDetectorProfileRunner extends AbstractProfileRunner {
    ...
    public void profile(String detectorId, ActionListener<DetectorProfile> listener, Set<DetectorProfileName> profilesToCollect) {
        logger.info("ylwudebug1 : profilesToCollect.size() {}", profilesToCollect.size());
    ...
    private void calculateTotalResponsesToWait(
        ...
        client.get(getDetectorRequest, ActionListener.wrap(getDetectorResponse -> {
            logger.info("ylwudebug1: getDetectorResponse is {}", getDetectorResponse != null && getDetectorResponse.isExists());
            if (getDetectorResponse != null && getDetectorResponse.isExists()) {
                try (
                    ...
                    logger.info("ylwudebug1: detector is {}", detector);
    ...
    private void prepareProfile(
        ...
        client.get(getRequest, ActionListener.wrap(getResponse -> {
            logger.info("ylwudebug1: get job response: {}", getResponse != null && getResponse.isExists());
                ...
                try (
                    ...
                    if (isMultiEntityDetector) {
                        ...
                        if (profilesToCollect.contains(DetectorProfileName.AD_TASK)) {
                            totalResponsesToWait++;
                            logger.info("ylwudebug1: 11 totalResponsesToWait {}", totalResponsesToWait);
                        }
                        logger.info("ylwudebug1: totalResponsesToWait {}", totalResponsesToWait);
                    } else {
                    ...
                    if (profilesToCollect.contains(DetectorProfileName.ERROR)) {
                        ...
                        adTaskManager.getLatestADTask(detectorId, ADTaskType.REALTIME_TASK_TYPES, adTask -> {
                            logger.info("ylwudebug1: adTask is {}", adTask.get());
                    ...
                    if (isMultiEntityDetector) {
                        ...
                        logger.info("ylwudebug1: getLatestHistoricalTaskProfile 00000");
                        if (profilesToCollect.contains(DetectorProfileName.AD_TASK)) {
                            logger.info("ylwudebug1: getLatestHistoricalTaskProfile 111");
