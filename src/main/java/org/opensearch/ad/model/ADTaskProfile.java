...
public class ADTaskProfile implements ToXContentObject, Writeable {
    ...
    public static final String HC_BATCH_TASK_CACHE_LAST_ACCESS_TIME_FIELD = "hc_batch_task_cache_last_access_time";
    ...
    private Long hcBatchTaskCacheLastAccessTime;
    ...
    public ADTaskProfile(
        ...
        Long hcBatchTaskCacheLastAccessTime
    ) {
        this.adTask = adTask;
        this.shingleSize = shingleSize;
        this.rcfTotalUpdates = rcfTotalUpdates;
        ...
        this.hcBatchTaskCacheLastAccessTime = hcBatchTaskCacheLastAccessTime;
    }
    ...
    public ADTaskProfile(StreamInput input) throws IOException {
        ...
        if (input.available() > 0) {
            ...
            this.hcBatchTaskCacheLastAccessTime = input.readOptionalLong();
        }
    }
    ...
    public void writeTo(StreamOutput out, Version adVersion) throws IOException {
        ...
        if (ADVersionUtil.compatibleWithVersionOnOrAfter1_1(adVersion)) {
            ...
            out.writeOptionalLong(hcBatchTaskCacheLastAccessTime);
        }
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (hcBatchTaskCacheLastAccessTime != null) {
            xContentBuilder.field(ENTITY_TASK_PROFILE_FIELD, hcBatchTaskCacheLastAccessTime);
        }
    ...
    public static ADTaskProfile parse(XContentParser parser) throws IOException {
        ...
        Long hcBatchTaskCacheLastAccessTime = null;
        ...
        while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
            ...
            switch (fieldName) {
                ...
                case ENTITY_TASK_PROFILE_FIELD:
                    ...
                    break;
                case HC_BATCH_TASK_CACHE_LAST_ACCESS_TIME_FIELD:
                    hcBatchTaskCacheLastAccessTime = parser.longValue();
                    break;
                default:
                    parser.skipChildren();
                    break;
        ...
        return new ADTaskProfile(
            ...
            runningEntities,
            hcBatchTaskCacheLastAccessTime
        );
    }
    ...
    public Long getHcBatchTaskCacheLastAccessTime() {
        return hcBatchTaskCacheLastAccessTime;
    }

    public void setHcBatchTaskCacheLastAccessTime(Long hcBatchTaskCacheLastAccessTime) {
        this.hcBatchTaskCacheLastAccessTime = hcBatchTaskCacheLastAccessTime;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(adTask, that.adTask)
            ...
            && Objects.equals(hcBatchTaskCacheLastAccessTime, that.hcBatchTaskCacheLastAccessTime)
