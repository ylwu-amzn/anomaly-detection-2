...
public class ADTaskProfile implements ToXContentObject, Writeable {
    ...
    public String toString() {
        return "ADTaskProfile{" +
                ...
                ", detectorTaskSlots=" + detectorTaskSlots +
                ", totalEntitiesInited=" + totalEntitiesInited +
                ...
                ", latestHCTaskRunTime=" + latestHCTaskRunTime +
                ", entityTaskProfiles=" + entityTaskProfiles +
                '}';
    }
}
