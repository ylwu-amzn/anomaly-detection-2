...
//                    );
    ...
    /**
     * Start historical analysis on coordinating node.
...
//    }
    ...
    public synchronized void updateADHCDetectorTask(
        ...
        Boolean updating = adTaskCacheManager.isHCDetectorTaskUpdating(detectorId);
        if (updating == null) {
        ...
        if (!updating) {
            ...
            logger.debug("HC detector task is updating, detectorId:{}, taskId:{}", detectorId, taskId);
        }
    }
    ...
    public void updateLatestRealtimeADTask(String detectorId, Map<String, Object> updatedFields) {
        updateLatestADTask(detectorId, REALTIME_TASK_TYPES, updatedFields);
    }
